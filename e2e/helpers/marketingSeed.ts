...
const APPOINTMENTS: AppointmentRecord[] = [
  ...
  makeAppointment({
    ...
    endTime: iso("2026-04-01T09:15:00-07:00"),
    expectedCompletionTime: iso("2026-04-01T09:30:00-07:00"),
    status: "completed",
    totalPrice: 135,
    depositPaid: true,
    completedAt: iso("2026-04-01T09:40:00-07:00"),
    jobPhase: "completed",
    client: { id: "client-harper", firstName: "Harper", lastName: "Brooks", phone: "555-771-0988", email: "harper.brooks@example.com" },
    vehicle: { id: "veh-harper", year: 2020, make: "Audi", model: "Q7", color: "Navarra Blue", licensePlate: "Q7FLEET" },
    assignedStaff: { id: "staff-marco", firstName: "Marco", lastName: "Silva" },
  ...
  makeAppointment({
    id: "appt-ppf-consult",
    title: "PPF Consultation",
    startTime: iso("2026-04-02T14:00:00-07:00"),
    endTime: iso("2026-04-02T15:00:00-07:00"),
    expectedCompletionTime: iso("2026-04-02T15:00:00-07:00"),
    status: "confirmed",
    totalPrice: 95,
    depositPaid: true,
    jobPhase: "scheduled",
  ...
  makeAppointment({
    id: "appt-coating-maintenance",
    title: "Coating Maintenance",
    startTime: iso("2026-04-03T10:30:00-07:00"),
    endTime: iso("2026-04-03T12:00:00-07:00"),
    expectedCompletionTime: iso("2026-04-03T12:15:00-07:00"),
    status: "scheduled",
    totalPrice: 145,
    depositPaid: true,
    jobPhase: "scheduled",
  ...
  makeAppointment({
    id: "appt-wheel-coating",
    title: "Wheel Coating",
    startTime: iso("2026-04-14T09:00:00-07:00"),
    endTime: iso("2026-04-14T11:00:00-07:00"),
    expectedCompletionTime: iso("2026-04-14T11:30:00-07:00"),
    status: "confirmed",
    totalPrice: 240,
    depositAmount: 80,
    depositPaid: true,
  ...
  makeAppointment({
    id: "appt-express-detail",
    title: "Express Detail",
    startTime: iso("2026-04-15T13:00:00-07:00"),
    endTime: iso("2026-04-15T15:00:00-07:00"),
    expectedCompletionTime: iso("2026-04-15T15:20:00-07:00"),
    status: "scheduled",
    totalPrice: 210,
    depositPaid: true,
    jobPhase: "scheduled",
  ...
  makeAppointment({
    id: "appt-headlight-restore",
    title: "Headlight Restoration",
    startTime: iso("2026-04-16T08:45:00-07:00"),
    endTime: iso("2026-04-16T10:15:00-07:00"),
    expectedCompletionTime: iso("2026-04-16T10:30:00-07:00"),
    status: "completed",
    totalPrice: 125,
    depositPaid: true,
    completedAt: iso("2026-04-16T10:40:00-07:00"),
    jobPhase: "completed",
    client: { id: "client-noah", firstName: "Noah", lastName: "Martinez", phone: "555-440-9013", email: "noah.martinez@example.com" },
    vehicle: { id: "veh-noah", year: 2021, make: "Toyota", model: "Tacoma", color: "Cement", licensePlate: "TACO21" },
    assignedStaff: { id: "staff-jake", firstName: "Jake", lastName: "Holloway" },
  ...
  makeAppointment({
    id: "appt-signature-detail",
    title: "Signature Detail",
    startTime: iso("2026-04-17T09:30:00-07:00"),
    endTime: iso("2026-04-17T13:30:00-07:00"),
    expectedCompletionTime: iso("2026-04-17T14:00:00-07:00"),
    status: "confirmed",
    totalPrice: 540,
    depositAmount: 150,
    depositPaid: true,
  ...
  makeAppointment({
    id: "appt-saturday-maintenance",
    title: "Saturday Maintenance Wash",
    startTime: iso("2026-04-18T08:30:00-07:00"),
    endTime: iso("2026-04-18T09:45:00-07:00"),
    expectedCompletionTime: iso("2026-04-18T10:00:00-07:00"),
    status: "scheduled",
    totalPrice: 95,
    depositPaid: true,
    jobPhase: "scheduled",
  ...
  makeAppointment({
    id: "appt-suv-reset",
    title: "SUV Interior Reset",
    startTime: iso("2026-04-18T11:15:00-07:00"),
    endTime: iso("2026-04-18T13:15:00-07:00"),
    expectedCompletionTime: iso("2026-04-18T13:30:00-07:00"),
    status: "confirmed",
    totalPrice: 225,
    depositPaid: true,
    jobPhase: "scheduled",
  ...
  makeAppointment({
    id: "appt-ceramic-followup",
    title: "Ceramic Follow-up",
    startTime: iso("2026-04-22T10:00:00-07:00"),
    endTime: iso("2026-04-22T11:00:00-07:00"),
    expectedCompletionTime: iso("2026-04-22T11:15:00-07:00"),
    status: "completed",
    totalPrice: 110,
    depositPaid: true,
    completedAt: iso("2026-04-22T11:20:00-07:00"),
    jobPhase: "completed",
    client: { id: "client-elena", firstName: "Elena", lastName: "Torres", phone: "555-210-8890", email: "elena@coastlineclients.com" },
    vehicle: { id: "veh-elena", year: 2023, make: "Tesla", model: "Model Y", color: "Pearl White", licensePlate: "DETAILY" },
    assignedStaff: { id: "staff-jake", firstName: "Jake", lastName: "Holloway" },
  ...
  makeAppointment({
    id: "appt-new-client-detail",
    title: "New Client Detail",
    startTime: iso("2026-04-23T09:15:00-07:00"),
    endTime: iso("2026-04-23T12:15:00-07:00"),
    expectedCompletionTime: iso("2026-04-23T12:45:00-07:00"),
    status: "confirmed",
    totalPrice: 320,
    depositAmount: 100,
    depositPaid: true,
  ...
  makeAppointment({
    id: "appt-delivery-prep",
    title: "Delivery Prep Detail",
    startTime: iso("2026-04-24T12:30:00-07:00"),
    endTime: iso("2026-04-24T15:30:00-07:00"),
    expectedCompletionTime: iso("2026-04-24T16:00:00-07:00"),
    status: "scheduled",
    totalPrice: 285,
    depositAmount: 75,
    depositPaid: true,
  ...
  makeAppointment({
    id: "appt-april-mobile-maintenance",
    title: "Mobile Maintenance Detail",
    startTime: iso("2026-04-27T08:00:00-07:00"),
    endTime: iso("2026-04-27T09:30:00-07:00"),
    expectedCompletionTime: iso("2026-04-27T09:45:00-07:00"),
    status: "scheduled",
    totalPrice: 155,
    depositPaid: true,
    jobPhase: "scheduled",
    isMobile: true,
    mobileAddress: "318 Ocean Crest, Irvine, CA",
    client: { id: "client-priya", firstName: "Priya", lastName: "Singh", phone: "555-551-7720", email: "priya.singh@example.com" },
    vehicle: { id: "veh-priya", year: 2024, make: "BMW", model: "X3", color: "Brooklyn Gray", licensePlate: "COASTX3" },
    assignedStaff: { id: "staff-marco", firstName: "Marco", lastName: "Silva" },
    location: { name: "Mobile Crew" },
  ...
  makeAppointment({
    id: "appt-month-end-detail",
    title: "Month-end Full Detail",
    startTime: iso("2026-04-29T09:00:00-07:00"),
    endTime: iso("2026-04-29T12:30:00-07:00"),
    expectedCompletionTime: iso("2026-04-29T13:00:00-07:00"),
    status: "confirmed",
    totalPrice: 410,
    depositAmount: 125,
    depositPaid: true,
  ...
  makeAppointment({
    id: "appt-april-wrap-prep",
    title: "Wrap Prep Wash",
    startTime: iso("2026-04-30T11:00:00-07:00"),
    endTime: iso("2026-04-30T12:30:00-07:00"),
    expectedCompletionTime: iso("2026-04-30T12:45:00-07:00"),
    status: "scheduled",
    totalPrice: 165,
    depositPaid: true,
    jobPhase: "scheduled",
