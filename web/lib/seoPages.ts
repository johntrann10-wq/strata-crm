...
const pages: SeoPageConfig[] = [
  ...
  },
  {
    ...
    fitPoints: ["A phone-friendly CRM and invoice flow", "Cleaner repeat-customer history", "Less friction than stitching together small tools"],
  ...
  },
  {
    ...
    seoDescription: "Strata is window tint shop software built for tint businesses that need cleaner scheduling, vehicle context, quote approval, and invoice follow-through.",
  ...
  },
  {
    ...
    audience: "Built for independent mechanics, small service shops, and mixed automotive businesses that still need real control.",
    pains: [
    ...
    ctaTitle: "Run your mechanic shop with a clearer daily operating system.",
  ...
  },
  {
    ...
    fitPoints: ["Cleaner vehicle-centric customer records", "A more premium day-to-day operating surface", "Better visibility across quoting, booking, and invoicing"],
  ...
  },
  {
    ...
    fitPoints: ["A lighter daily operating system", "Better vehicle and invoice continuity", "More trust and polish in front of customers"],
  ...
  },
  {
    ...
    seoDescription: "Strata is shop scheduling software for automotive businesses that need a cleaner month-to-day calendar, client and vehicle context, and a tighter appointment flow.",
