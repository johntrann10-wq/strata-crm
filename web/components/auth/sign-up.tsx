  ...
  return (
    <div className="mx-auto w-full max-w-[24rem] sm:max-w-md">
      ...
      <div className="mb-6 text-center sm:mb-8">
        <h1 className="text-2xl font-semibold tracking-tight text-foreground sm:text-[22px]">Create your account</h1>
        <p className="mt-1.5 text-[15px] leading-6 text-muted-foreground sm:text-[13px] sm:leading-5">
          {isInviteFlow && inviteState.businessName
            ...
            : isNativeShellSession
              ? "Create your Strata account and finish setup entirely in the app."
          ...
          <div className="flex flex-col gap-5">
            ...
            {authError ? (
              <div className="rounded-xl border border-destructive/20 bg-destructive/5 px-4 py-3 text-left">
                <p className="text-[13px] font-semibold text-destructive">We couldn&apos;t create your account yet.</p>
            ...
            <Button
              ...
              type="submit"
            >
              {isSubmitting ? "Creating account..." : isNativeShellSession ? "Create account" : "Start free trial"}
            </Button>
