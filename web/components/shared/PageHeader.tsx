    ...
    <div className="app-page-header surface-panel relative mb-4 overflow-hidden rounded-[1.7rem] sm:mb-7">
      ...
      <div className="relative min-w-0 flex-1">
        {backTo && (
          <Link
            to={backTo}
            className="app-page-header-back mb-3 inline-flex items-center gap-1.5 rounded-full border border-border/70 bg-background/80 px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.16em] text-muted-foreground transition-colors hover:text-foreground"
          >
