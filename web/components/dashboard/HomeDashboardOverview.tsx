              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {activeDay.appointmentCount} appointments Â· {formatDashboardCurrency(activeDay.bookedValue)} booked
                  </p>
                </div>
                    ...
                    >
                      <div className="min-w-0">
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                          {item.clientName} Â· {item.vehicleLabel}
                        </p>
                      </div>
              ...
              <Link key={item.id} to={item.urls.appointment} className="block rounded-[1rem] border border-border/70 bg-white/80 p-3 transition-colors hover:border-orange-200 hover:bg-orange-50/60">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    <p className="font-semibold text-slate-950">{item.title}</p>
                    <p className="mt-1 text-sm text-muted-foreground">
                      {item.client.name} Â· {item.vehicle.label}
                    </p>
